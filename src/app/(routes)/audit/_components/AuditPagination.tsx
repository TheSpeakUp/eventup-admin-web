...
// Offset/limit pagination — the audit list endpoint returns `total` plus a page
// of `items`, so we compute Prev/Next deterministically (mirrors payments).
...
type Props = {
  ...
  offset: number;
  basePath: string;
  // Filter params preserved across page links.
...
export default function AuditPagination({
  ...
  return (
    ...
    >
      <span className="text-xs text-zinc-500" data-testid="audit-range">
